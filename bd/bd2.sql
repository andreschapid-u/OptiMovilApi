...
INSERT IGNORE INTO `categories` (`id`, `created_at`, `updated_at`, `name`) VALUES
	(1, '2022-06-26 14:27:52', NULL, 'Hombre');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- Volcando datos para la tabla optimovilapi.clients: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `clients` DISABLE KEYS */;
INSERT IGNORE INTO `clients` (`id`, `created_at`, `updated_at`, `name`, `second_name`, `first_last_nam`, `second_last_name`, `email`, `password`, `phone_number`) VALUES
...
INSERT IGNORE INTO `cms_apicustom` (`id`, `permalink`, `tabel`, `aksi`, `kolom`, `orderby`, `sub_query_1`, `sql_where`, `nama`, `keterangan`, `parameter`, `created_at`, `updated_at`, `method_type`, `parameters`, `responses`) VALUES
...
INSERT IGNORE INTO `cms_apikey` (`id`, `screetkey`, `hit`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cms_email_templates` (`id`, `name`, `slug`, `subject`, `content`, `description`, `from_name`, `from_email`, `cc_email`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cms_logs` (`id`, `ipaddress`, `useragent`, `url`, `description`, `details`, `id_cms_users`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cms_menus` (`id`, `name`, `type`, `path`, `color`, `icon`, `parent_id`, `is_active`, `is_dashboard`, `id_cms_privileges`, `sorting`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cms_menus_privileges` (`id`, `id_cms_menus`, `id_cms_privileges`) VALUES
	(1, 1, 1),
	(3, 3, 1),
	(4, 4, 1),
	(5, 5, 1),
...
INSERT IGNORE INTO `cms_moduls` (`id`, `name`, `icon`, `path`, `table_name`, `controller`, `is_protected`, `is_active`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT IGNORE INTO `cms_privileges` (`id`, `name`, `is_superadmin`, `theme_color`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cms_privileges_roles` (`id`, `is_visible`, `is_create`, `is_read`, `is_edit`, `is_delete`, `id_cms_privileges`, `id_cms_moduls`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `cms_settings` (`id`, `name`, `content`, `content_input_type`, `dataenum`, `helper`, `created_at`, `updated_at`, `group_setting`, `label`) VALUES
...
INSERT IGNORE INTO `cms_users` (`id`, `name`, `photo`, `email`, `password`, `id_cms_privileges`, `created_at`, `updated_at`, `status`) VALUES
...
INSERT IGNORE INTO `products` (`id`, `created_at`, `updated_at`, `name`, `description`, `image`, `image_path`, `stock`, `price`, `category_id`, `type_id`) VALUES
...
INSERT IGNORE INTO `product_fav_client` (`id`, `client_id`, `product_id`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `types` (`id`, `created_at`, `updated_at`, `name`) VALUES
