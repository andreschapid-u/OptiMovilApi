<?php namespace App\Http\Controllers;
	...
	class AdminClientsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Primer nombre","name"=>"name"];
			$this->col[] = ["label"=>"Segundo nombre","name"=>"second_name"];
			$this->col[] = ["label"=>"Primer apellido","name"=>"first_last_nam"];
			$this->col[] = ["label"=>"Segundo apellido","name"=>"second_last_name"];
			$this->col[] = ["label"=>"Correo","name"=>"email"];
			$this->col[] = ["label"=>"Teléfono","name"=>"phone_number"];
			$this->col[] = ["label"=>"Contraseña","name"=>"password"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Primer nombre','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'Segundo nombre','name'=>'second_name','type'=>'text','validation'=>'required|min:3|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Primer apellido','name'=>'first_last_nam','type'=>'text','validation'=>'required|min:3|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Segundo apellido','name'=>'second_last_name','type'=>'text','validation'=>'required|min:3|max:255','width'=>'col-sm-10'];
